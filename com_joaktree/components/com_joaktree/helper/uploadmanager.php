...
// { print_r('het gaat hier fout'); stop11();				
				// return false;
// }
			// 
...
// print_r($_FILES);			
// 
// print_r('; keyfield = '. $this->key_field);			
// print_r('; source 1 = '.$this->get_param($_FILES, $this->key_field)); 
// print_r('; source 2 = '.$this->get_param($this->get_param($_FILES, $this->key_field), 'tmp_name')); 
// 
			// if(!$this->file_copy ($path, $this->get_param($this->get_param($_FILES, $this->key_field), 'tmp_name')))
// { print_r('tweede plaats gaat hier fout'); stop22();				
				// return false;
// }
// 
			// /* file name */
