...
class com_joaktreeInstallerScript
{
        ...
        public function install($installer){
			...
			$update_queries[] = 
			   ...
			   .', living           tinyint(1)   unsigned NOT NULL default 0 '
			   .', page             tinyint(1)   unsigned NOT NULL default 0 '
			...
			// Table joaktree_event_domains
			$update_queries[] = 
			    'CREATE TABLE IF NOT EXISTS '
			   .'#__joaktree_event_domains '
			   .'( id 		        int(11)      unsigned NOT NULL auto_increment '
			...
			$update_queries[] = 
			   ...
			   .', kunenacatid      int(11)      unsigned     NULL '
			   .', PRIMARY KEY  (id) '
			   .') '
			   .'COMMENT="'.$version.'" ';
			// end: joaktree_trees
			...
			// Table joaktree_tree_users
			$update_queries[] = 
			    'CREATE TABLE IF NOT EXISTS '
			   .'#__joaktree_tree_users '
			   .'( user_id          int(11)      unsigned NOT NULL '
			   .', app_id           int(11)      unsigned     NULL '
			   .', tree_id          int(11)      unsigned     NULL '
			   .', usergroup1_id    int(11)      unsigned     NULL '
			   .', papp_id          int(11)      unsigned     NULL '
			   .', person_id        varchar(20)               NULL '
			   .', params           text                      NULL '
			   .', PRIMARY KEY  (user_id) '
			   .') '
			   .'COMMENT="'.$version.'" ';
			// end: joaktree_tree_users
