			...
			<thead>
				<tr>
					...
					<th class="nowrap hidden-phone">
						<?php echo JHTML::_('grid.sort', 'JTFAMTREE_HEADING_TREE', 'jte.name', $this->lists['order_Dir'], $this->lists['order'] ); ?>
					</th>
					<th class="nowrap hidden-phone">
						<?php echo JHtml::_('grid.sort', 'JTFAMTREE_HEADING_APPTITLE', 'japp.title', $this->lists['order_Dir'], $this->lists['order']); ?>
					</th>
					<th class="nowrap hidden-phone">
						<?php echo JText::_( 'JTFAMTREE_HEADING_NUMBEROFPERSONS' ); ?>
					</th>				
					<th class="nowrap hidden-phone">
						<?php echo JHtml::_('grid.sort', 'JTFAMTREE_HEADING_GENDEX', 'jte.indGendex', $this->lists['order_Dir'], $this->lists['order']); ?>
					</th>
					<th class="nowrap hidden-phone"> 
					...
					<th class="nowrap hidden-phone">
						<?php echo JHtml::_('grid.sort', 'JT_HEADING_ACCESS', 'access_level ', $this->lists['order_Dir'], $this->lists['order']); ?>
					</th>
					<th class="nowrap hidden-phone">
						<?php echo JHtml::_('grid.sort', 'JT_HEADING_THEME', 'theme ', $this->lists['order_Dir'], $this->lists['order']); ?>
					</th>
			...
			<tbody>
				<?php foreach ($this->items as $i => $row) {
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td class="small hidden-phone">
							<?php echo JText::_(($row->indGendex == 2) ? 'JYES':  'JNO'); ?>
						</td>
						<td class="small hidden-phone">
							<?php echo $row->root_person_id; ?>
						</td>
						<td class="small hidden-phone">
							<?php echo $row->firstName; ?> <?php echo $row->familyName; ?>
						</td>
